        ...
        <div class="container">
          <div class="row">
            <div class="col-sm-12 col-lg-3 d-md-none d-lg-block col-xs-center">
              <img src="img/logo-brand.png" alt="Moody" class="main-logo">
            </div>
            ...
            <div class="col-sm-4 col-lg-3">
              <div class="text-right">
                <a href="tel:+77078875631">+77078875631</a><br>
                <a href="whatsapp:+77078875631">+77078875631</a><br>
              </div>
            </div>
            <!-- <div class="d-none d-sm-block d-md-none col-lg-3">
                  ...
                  <div class="branding">
                    <div class="branding__logo">
                      <a href="./">
                        ...
                        <!-- <img src="img/logo-mini.png" alt="Moody" class="dark-logo"> -->
                      </a>
                    </div>
                  </div>
                </div>
                <div class="header-right">
                  <div class="popup-search-wrap d-block d-sm-none">
                      ...
                      <ul>
                        <li class="menu-item-has-children mega-menu">
                          <a href="./">
                            ...
                            <span class="menu-item-title text-uppercase">Home</span>
                        ...
                        <li class="menu-item-has-children">
                          <a href="#">
                            <span class="sub-arrow">+</span>
                            <span class="menu-item-title text-uppercase">Pages</span>
                            <span class="toggle-sub-menu"> </span>
                          </a>
                          <ul class="sub-menu">
                        ...
                        <li class="menu-item-has-children mega-menu">
                          <a href="#">
                            <span class="sub-arrow">+</span>
                            <span class="menu-item-title text-uppercase">Elements</span>
                            <span class="toggle-sub-menu"> </span>
                          </a>
                          <ul class="sub-menu">
                            <li>
                        ...
                        <li class="menu-item-has-children">
                          <a href="#">
                            <span class="sub-arrow">+</span>
                            <span class="menu-item-title text-uppercase">Blog</span>
                            <span class="toggle-sub-menu"> </span>
                          </a>
                          <ul class="sub-menu">
                        ...
                        <li class="menu-item-has-children">
                          <a href="#">
                            <span class="sub-arrow">+</span>
                            <span class="menu-item-title text-uppercase">Portfolio</span>
                            <span class="toggle-sub-menu"> </span>
                          </a>
                          <ul class="sub-menu">
                            <li class="menu-item-has-children">
                              <a href="#">
                                <span class="sub-arrow">+</span>
                                <span class="menu-item-title text-uppercase">Classic</span>
                                <span class="toggle-sub-menu"> </span>
                              </a>
                              <ul class="sub-menu">
                        ...
                        <li class="menu-item-has-children">
                          <a href="#">
                            <span class="sub-arrow">+</span>
                            <span class="menu-item-title text-uppercase">Shop</span>
                            <span class="toggle-sub-menu"> </span>
                          </a>
                          <ul class="sub-menu">
            ...
            <div class="row">
              <div class="col-sm-8 offset-sm-2">
                <div class="text-center">
                  ...
                  <div class="mb-5"></div>
                  <img src="img/sign_01-mini.png" alt="" />
                  <div class="mb-2"></div>
                ...
                <div class="product-item">
                  <div class="product-thumbnail">
                    <a href="shop-detail.html">
                      <img src="img/shop-mini/shop_400x510.jpg" alt="" />
                    </a>
                    <div class="actions">
            ...
            <div class="row">
              <div class="col-sm-12">
                <div class="partner-slider" data-auto-play="true" data-desktop="4" data-laptop="4" data-tablet="2" data-mobile="1">
                  <div class="image">
                    <img src="img/partner-mini/partner_189x45.jpg" alt="Slide Image" />
                  </div>
                  <div class="image">
                    <img src="img/partner-mini/partner_189x45.jpg" alt="Slide Image" />
                  </div>
          ...
          <div class="container">
            <div class="row">
              <div class="col-sm-4 col-lg-7 col-md-6">
                <img src="img/logo_light-mini.png" alt="">
                <div class="mb-4"></div>
