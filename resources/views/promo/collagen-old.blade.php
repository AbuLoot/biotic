      ...
      <div class="container">
        ...
        <div class="row header-main-content">
          <div class="offset-md-2- col-sm-8">
            <h1 class="heading text-center- text-uppercase header-title"><span class="color-green">BEEF PROTEIN</span> до&nbsp;8&nbsp;кг мышечной массы за&nbsp;1&nbsp;месяц</h1>
      ...
      <div class="container">
        <div class="row pt-8 pb-8">
          <div class="col-sm-12 col-lg-8">
            <h2 class="text-uppercase fz-50- text-white"> Почему важен <span class="primary-color">BEEF PROTEIN</span>?</h2>
            ...
            <ul class="list-who-needs">
              <li>к мышечному стрессу</li>
              <li>нарушению синтезов белков,</li>
              <li>нарушению обмена веществ,</li>
              <li>нервным расстройствам,
              <li>что в итоге приводит к ослаблению функций памяти и снижению иммунитета.</li>
            </ul>
          </div>
